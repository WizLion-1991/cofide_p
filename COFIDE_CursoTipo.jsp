        ...
        <table class="table1">
            <%
                ...
                String strSQLNFecha = "select count(CC_FECHA_INICIAL) as NFechas , CC_FECHA_INICIAL"
                        + " from cofide_cursos where " + strTipos + " and CC_FECHA_INICIAL >= '" + fec.getFechaActual() + "' GROUP BY CC_FECHA_INICIAL ORDER BY CC_FECHA_INICIAL";
            ...
            <tr class="tr1">
                ...
                <%
                    String strSQL = "select *,"
                            ...
                            + "from cofide_cursos cc where " + strTipos + " and CC_FECHA_INICIAL = '" + rsNFechas.getString("CC_FECHA_INICIAL") + "' order by CC_FECHA_INICIAL";
