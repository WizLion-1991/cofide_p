      ...
      <div>
         <div class="login-greeting">
            <table class="mlm_down1" cellpadding="3" cellspacin="0">
               <tr><td nowrap>&nbsp;P. personales:</td><td>&nbsp;<strong><%=NumberString.FormatearDecimal(cliente.getFieldDouble("CT_PPUNTOS"), 2)%></strong></td></tr>
               <tr><td nowrap>&nbsp;P. grupales:</td><td>&nbsp;<strong><%=NumberString.FormatearDecimal(cliente.getFieldDouble("CT_GPUNTOS"), 2)%></strong></td></tr>
               <tr><td nowrap>&nbsp;VN. personal:</td><td>&nbsp;<strong><%=NumberString.FormatearDecimal(cliente.getFieldDouble("CT_PNEGOCIO"), 2)%></strong></td></tr>
               <tr><td nowrap>&nbsp;VN. grupal:</td><td>&nbsp;<strong><%=NumberString.FormatearDecimal(cliente.getFieldDouble("CT_GNEGOCIO"), 2)%></strong></td></tr>
               <tr><td nowrap>&nbsp;Nivel de red:</td><td>&nbsp;<strong><%=cliente.getFieldDouble("CT_NIVELRED")%></strong></td></tr>
               <tr><td nowrap>&nbsp;VN. comision:</td><td>&nbsp;<strong><%=NumberString.FormatearDecimal(cliente.getFieldDouble("CT_COMISION"), 2)%></strong></td></tr>
      ...
      <div>
         <ul>
            ...
            <li><a href="index.jsp?mod=FZWebRed" class="aMenu"><img src="images/red.png" border="0" width="40" height="40" alt="Mi Red" title="Mi Red" />Mi Red</a></li>
             <li><a href="index.jsp?mod=FZAnaPlan" class="aMenu"><img src="images/LogoWenow.png" border="0" width="40" height="40" alt="Añadir Plan" title="Añadir Plan" />Añadir Plan</a></li>
         </ul>
      </div>
      <h3>Mis reportes</h3>
      <div>
