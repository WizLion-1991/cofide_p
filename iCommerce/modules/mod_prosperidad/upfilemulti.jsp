...
<%
 ...
 /* Get the name attribute value of the <input type="file"> element. */
                    ...
                    if (fileName.toLowerCase().endsWith(".pdf")) {
                        ...
                        String strInsert = "INSERT INTO mlm_listado (LIS_NOMARCHIVO, LIS_PATHIMGFORM, CT_ID,LIS_FECHA,LIS_HORA,CT_RAZONSOCIAL) values ('" + fileName + "', '" + strPathUsado + "', '" + varSesiones.getintIdCliente() + "','" + fechas.getFechaActual() + "','" + fechas.getHoraActual() + "','" + varSesiones.getStrUser() + "') ";
