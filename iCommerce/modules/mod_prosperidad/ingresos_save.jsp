   ...
   if (varSesiones.getIntNoUser() != 0) {
      ...
      if (captcha.isCorrect(strAnswer)) {
         ...
         if (strResult.equals("OK")) {
            ...
            String strInsert = "INSERT INTO mlm_listado (PROS_FOLIO, CT_ID, LIS_FECHA, LIS_HORA, CT_RAZONSOCIAL) values ('"+ strFolio +"','" + idCt + "','" + fechas.getFechaActual() + "','" + fechas.getHoraActual() + "','" + strRazonSocial + "') ";
