...
<div class="well ">
   <h3 class="page-header">Mi red <%=cliente.getFieldString("CT_NOMBRE")%>&nbsp;<%=cliente.getFieldString("CT_APATERNO")%>&nbsp;<%=cliente.getFieldString("CT_AMATERNO")%>&nbsp;<%=strTituloTipo%>&nbsp;</h3>
   <div class="userdata">       
