...
<script type="text/javascript" src="modules/mod_ecomm/js/ventas.js"></script>
<script type="text/javascript" src="modules/mod_ecomm/js/ecomm_mx.js"></script>
<script type="text/javascript" src="modules/mod_klensy/js/ecomm.js?date=<%=strNow%>"></script>
<!--slide 3d -->
...
<!--slide 3d -->
<!--light box -->
<script type="text/javascript" src="modules/mod_ecomm/js/jquery.lightbox-0.5.min.js"></script>
<link rel="stylesheet" type="text/css" href="modules/mod_ecomm/css/jquery.lightbox-0.5.css" media="screen" />
<!--light box -->
<!--ecommerce -->
<link rel="stylesheet" type="text/css" href="modules/mod_klensy/css/ecomm.css?date=<%=strNow%>" />
<%if (browserType.contains("Safari")) {%>
<link rel="stylesheet" type="text/css" href="modules/mod_ecomm/css/ecomm_safari.css?date=<%=strNow%>" />
<%}%>
<%if (browserType.contains("Chrome")) {%>
<link rel="stylesheet" type="text/css" href="modules/mod_ecomm/css/ecomm_chrome.css?date=<%=strNow%>" />
<%}%>
<!-- Valores globales -->
      ...
      <div id="tabs">
         <div id="tabs-1" >
            ...
            <div>Acepto terminos y condiciones?<input type="checkbox" name="aceptoT" class="Condiciones" id="aceptoT" value="1" ></div>    
                <div><img alt="Captcha"  id="captcha_img" src="../stickyImg" />Escriba el texto de la imagen:<input type="text" name="answer" id="answer" value="" maxlength="30" size="15" /></div>
                <button type="button" tabindex="1" name="Refrescar" class="btn btn-primary btn" onclick="recargaCaptcha()" >Cambiar imagen</button>
         ...
         <div id="tabs-6" style="display: none">
            ...
            <div>Mercado Pago:<div id="link"></div>
            </div>
...
<!--Mensajes de promociones-->
<!--Busqueda-->
<jsp:include page="../../modules/mod_klensy/ecomm_search.jsp" />
<!--Busqueda-->
*Los precios incluyen IVA.
<div class="well" id="ecomm_content"></div>
<!--Pie de pagina del ecommerce -->
<jsp:include page="../../modules/mod_ecomm/ecomm_foot.jsp" />
<!--Pie de pagina del ecommerce -->
