   ...
   <div id="accordion">
      ...
      <div>
         <ul>
            ...
            <li><a href="index.jsp?mod=FZWebNvoCentro" class="aMenu"><img src="images/Cuenta nueva.jpg" border="0" width="40" height="40" alt="Nuevo centro de negocios" title="Nuevo centro de negocios" />&nbsp;Agregar cuenta</a></li>
         </ul>
      </div>
      <h3>Mis reportes</h3>
      <div>
      ...
      <div>
         <ul>
            <li><a href="index.jsp?mod=FZWebSugerencias" class="aMenu"><img src="images/sugerencias.png" border="0" width="40" height="40" alt="Sugerencias" title="Sugerencias" />Formulario Vehículo</a></li>
         </ul>
      </div>
   </div>
