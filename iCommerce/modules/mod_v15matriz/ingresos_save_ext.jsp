...
<%
    ...
    if (1 == 1 /*varSesiones.getIntNoUser() != 0*/) {
        ...
        if (captcha.isCorrect(strAnswer)) {
            ...
            String strSql = "select SC_ID,EMP_ID,MON_ID,TI_ID from vta_cliente where CT_ID = " + intSponsor;
            ...
            strSql = "select vta_sucursal.SC_ID,SC_CLAVE,SC_NOMBRE,"
                    ...
                    + " AND vta_cliente.CT_ID = " + intSponsor;
            ...
            if (strResEntrega.equals("OK")) {
                ...
                //Mail referenciado
                GeneraMailReferenciado(oConn, varSesiones, Integer.valueOf(objTabla.getValorKey()));
            }
            oConn.close();
        } else {
...
// #################### Funciones   ####################
    ...
    public String GeneraMailReferenciado(Conexion oConn, VariableSession varSesiones, int intNvoKey) {
        String strRes = "";
        String strEmail1 = "";
        String strEmail2 = "";
        int intSponzor = 0;
