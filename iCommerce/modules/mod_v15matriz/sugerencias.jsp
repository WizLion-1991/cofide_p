...
%>
<div class="well ">
    <h3 class="page-header">Datos de tu vehículo</h3>
    <form action="index.jsp?mod=sugerencias_save" method="post" onsubmit="return  EvaluaFormulario();"  id="login-form" class="form-inline">
        <div class="userdata">
            ...
            <div id="form-new-adirigido" class="control-group">
                <div class="controls">
                    <div class="input-prepend input-append">
                        ...
                        <input id="modlgn-dirigido" type="text" name="dirigido" value="Ventas" tabindex="0" size="30" maxlength="50" placeholder="A quien va dirigido"/><span class="required">*</span>
                    </div>
                </div>
            </div>
            <!--Correo-->
            <div id="form-new-correo" class="control-group">
                <div class="controls">
                    <div class="input-prepend input-append">
                        ...
                        <input id="modlgn-correo" type="text" name="correo" value="ventas@v15matriz.com" tabindex="0" size="30" maxlength="29" placeholder="Correo"/><span class="required">*</span>
            ...
            <!--Dirigido a-->
            <label for="modlgn-datos" >Vehículo, Versión, Modelo, Color, Nombre de la ciudad, Nombre de la agencia, Nombre del vendedor y Teléfono de la agencia.:</label>
