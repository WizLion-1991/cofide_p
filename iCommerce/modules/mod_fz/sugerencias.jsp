            ...
            <div id="form-new-adirigido" class="control-group">
                <div class="controls">
                    <div class="input-prepend input-append">
                        ...
                        <input id="modlgn-dirigido" type="text" name="dirigido"  tabindex="0" size="30" maxlength="50" placeholder="A quien va dirigido"/><span class="required">*</span>
                    </div>
                </div>
            </div>
            <!--Correo-->
            <div id="form-new-correo" class="control-group">
                <div class="controls">
                    <div class="input-prepend input-append">
                        ...
                        <input id="modlgn-correo" type="text" name="correo"  tabindex="0" size="30" maxlength="29" placeholder="Correo"/><span class="required">*</span>
