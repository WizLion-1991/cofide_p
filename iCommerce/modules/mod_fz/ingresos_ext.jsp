...
<%
   ...
   //consultamos zona de division
   String strzona = "select * from bambi_zonas";
   rs = oConn.runQuery(strzona, true);
   while (rs.next()) {
      lstZona.add(rs.getString("ZN_DIVISION"));
   }
   rs.close();
   //Consultamos los estados
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<%= webBase.getStrLanguage()%>" lang="<%= webBase.getStrLanguage()%>" dir="<%= webBase.getStrDirection()%>" >
   ...
   <body class="site com_content view-article no-layout no-task itemid-435">
      <div class="well ">
         ...
         <form action="modules/mod_fz/ingresos_save_ext.jsp" method="post" onsubmit="return  EvaluaFormulario();" id="login-form" class="form-inline">
            <div class="userdata">
