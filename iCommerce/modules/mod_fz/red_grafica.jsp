            ...
            <li>
               ...
               <ul>
                  ...
                  %><li id="n1_<%=rs.getInt("CT_ID")%>">
                     <%=rs.getInt("CT_ID")%>
                     <a href="index.jsp?mod=red_grafica&NodoHijo=<%=rs.getInt("CT_ID")%>"><img src="../images/mlm/<%=strNomImg%>" border="0" alt="<%=rs.getString("CT_RAZONSOCIAL")%>" title="<%=rs.getString("CT_RAZONSOCIAL")%>" /></a>
