...
<!-- Mostramos los datos -->
<div class="well ">
   <h3 class="page-header">Se ha registrado el nuevo socio con el siguiente numero:</br> <%=strKey%> </h3>
...
<!-- Mostramos los datos -->
<div class="well ">
   <h3 class="page-header">Error al registrar el nuevo socio, mensaje de error <%=strResult%> </h3>
