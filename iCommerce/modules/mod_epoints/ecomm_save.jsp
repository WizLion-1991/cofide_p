...
<%@page import="Tablas.MlmMovComis"%>
            ...
            if (strid.equals("1")) {
                    ...
                    if (strTipoVta.equals("3")) {
                        ...
                        if (request.getParameter("PD_ID") != null) {
                            ...
                            if (ticket.getDocument().getFieldInt("PD_ID") != 0) {
                                ...
                                ticket.getDocument().setValorKey(ticket.getDocument().getFieldInt("TKT_ID") + "");
                                ticket.Init();
                            }
                        }
                    }
                ...
                if (!strMailCte.isEmpty()) {
                    String strRespPdf = GeneraImpresionPDF(oConn, strPathXML,
                            "TICKET", ticket.getDocument().getFieldString("TKT_FOLIO"), Integer.valueOf(ticket.getDocument().getValorKey()),
                            strPathFonts);
                    System.out.println("strRespPdf" + strRespPdf);
                    if (strRespPdf.equals("OK")) {
                        String strRespEnvio = GeneraMail(oConn, strMailCte, "",
                                ticket.getDocument().getFieldString("TKT_FOLIO"),
                                strPathXML);
                        ...
                        objTabla.setFieldInt("CT_ID", varSesiones.getintIdCliente());
                        objTabla.setFieldDouble("MMC_CARGO", Double.valueOf(request.getParameter("TOTAL_PUNTOS")));
                        objTabla.setFieldDouble("MMC_ABONO", 0);
                        objTabla.setFieldString("MMC_NOTAS", "");
                        objTabla.setFieldInt("MMC_USUARIO", varSesiones.getIntNoUser());
                        objTabla.setFieldInt("FAC_ID", Integer.parseInt(ticket.getDocument().getFieldString("TKT_FOLIO")));
                        objTabla.setFieldInt("MC_ID", 0);
                        objTabla.setFieldInt("NC_ID", 0);
                        objTabla.setFieldInt("MPE_ID", periodo.getPeriodoActual(oConn));

                        objTabla.Agrega(oConn);
                    }
                }
...
<%!
    ...
    protected String GeneraMail(Conexion oConn, String strMailCte, String strMailCte2,
        ...
        if (!strsmtp_server.equals("")
            ...
            if (!strLstMail.equals("")) {
                ...
                mail.setFichero(strPath + "Ticket_web" + strFolio + ".pdf");
    ...
    protected String GeneraImpresionPDF(Conexion oConn, String strPath,
        ...
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(strPath + "Ticket_web" + strFolio + ".pdf"));
