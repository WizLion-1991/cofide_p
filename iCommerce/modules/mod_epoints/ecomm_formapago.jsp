...
<%
    ...
    if (varSesiones.getintIdCliente() > 0) {
        ...
        rsCN = oConn.runQuery(strSaldoDisponible, true);
        while (rsCN.next()) {
        ...
        strComiDisponible = NumberString.FormatearDecimal(dblDisponible, 2);
    }
...
<div id="FormasdePago">
    <ul>
        ...
        <li>Uso de puntos:<%=strComiDisponible%> Disponible, Valor en puntos: <input type="text" id="TOTAL_PUNTOS_X_GASTAR" name="TOTAL_PUNTOS_X_GASTAR"  readonly="true" />
