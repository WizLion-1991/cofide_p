...
<script type="text/javascript" src="modules/mod_ecomm/js/ecomm.js"></script>
<!--slide 3d -->
...
<!--light box -->
<!--ecommerce -->
<link rel="stylesheet" type="text/css" href="modules/mod_ecomm/css/ecomm.css" />
<%if (browserType.contains("Safari")) {%>
<link rel="stylesheet" type="text/css" href="modules/mod_ecomm/css/ecomm_safari.css" />
<%}%>
<%if (browserType.contains("Chrome")) {%>
<link rel="stylesheet" type="text/css" href="modules/mod_ecomm/css/ecomm_chrome.css" />
<%}%>
<!-- Valores globales -->
      ...
      <div id="tabs">
         ...
         <div id="tabs-2a" style="display: none">
            ...
            <table border="0">
               ...
               <tr>
                  <td colspan="2">&nbsp;Usar esta Dirección entrega&nbsp;
                     <%if(bolExistDirEnvio){%>
         ...
         <div id="tabs-4" style="display: none">
            ...
            <input type="button" name="step1" value="Guardar"  onClick="Step4()"/>
            <input type="button" name="stepback2" value="Regresar"  onClick="StepBack4()"/>
         </div>
         <div id="tabs-5" style="display: none">
            ...
            <input type="button" name="step1" value="Guardar"  onClick="Step5()"/>
...
<div class="wrapper">
   <ul id="sb-slider" class="sb-slider">
      <%
         ...
         strSql = "select * from ecom_slides where SL_ACTIVO = 1 order by SL_ORDEN";
         rs = oConn.runQuery(strSql, true);
         while (rs.next()) {
      %>
      <li>
...
<!--Mensajes de promociones-->
<!--Busqueda-->
<jsp:include page="../../modules/mod_ecomm/ecomm_search.jsp" />
<!--Busqueda-->
...
//Evento que ocurre al cargar la pantalla
               ...
               function Init() {
                  RefreshClas(document.getElementById("clas1"), 2);
                  _EvalPromociones();
               }
</script>
