<%-- 
    Document   : ecomm_car_checkout_confirm
    Created on : 03-sep-2014, 15:46:20
    Author     : ZeusGalindo
--%>
...
<div class="breadcrumb">
   <a style="color: white;" id="breadcumb_1" href="index.jsp?mod=ecomm_checkout">BOLSA DE COMPRAS</a>
   » <a style="color: white;" id="breadcumb_2" href="index.jsp?mod=ecomm_car_checkout_sell">REGISTRO</a>
   » <a style="color: gray;" id="breadcumb_3" href="">ENVIO</a>
   » <a style="color: white;" id="breadcumb_4" href="">PAGO</a>
   » <a style="color: white;" id="breadcumb_5" href="">GRACIAS</a>
</div>
...
<div>
   <div class="checkout">
      ...
      <div id="payment-address">
         <div class="checkout-heading" style="display:none;"><span>Paso 2: Detalles de facturación</span></div>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      ...
      $.ajax({
         url: 'modules/mod_ecomm/ecomm_eval_login.jsp?mod=json6',
         dataType: 'html',
   ...
   $('#button-account').live('click', function() {
      $.ajax({
         ...
         beforeSend: function() {
            ...
            $('#button-account').after('<span class="wait">&nbsp;<img src="http://casajosefa.com/catalog/view/theme/default/image/loading.gif" alt="" /></span>');
         },
         complete: function() {
      ...
      $.ajax({
         ...
         success: function(json) {
            ...
            if (json['redirect']) {
               ...
               $.ajax({
                  url: 'modules/mod_ecomm/ecomm_eval_login.jsp?mod=json7&route=checkout/payment_address',
                  dataType: 'html',
                  success: function(html) {
   ...
   $('#button-payment-address').live('click', function() {
      $.ajax({
         url: 'modules/mod_ecomm/ecomm_eval_login.jsp?mod=json5&route=payment_address/validate',
         type: 'post',
         data: $('#payment-address input[type=\'text\'], #payment-address input[type=\'password\'], #payment-address input[type=\'checkbox\']:checked, #payment-address input[type=\'radio\']:checked, #payment-address input[type=\'hidden\'], #payment-address select'),
         dataType: 'json',
         beforeSend: function() {
            $('#button-payment-address').attr('disabled', true);
            $('#button-payment-address').after('<span class="wait">&nbsp;<img src="http://casajosefa.com/catalog/view/theme/default/image/loading.gif" alt="" /></span>');
         },
         complete: function() {
         ...
         success: function(json) {
            ...
            if (json['redirect']) {
               ...
               $.ajax({
                  url: 'modules/mod_ecomm/ecomm_eval_login.jsp?mod=json5&route=checkout/shipping_address',
                  dataType: 'html',
                  success: function(html) {
                     $('#shipping-address .checkout-content').html(html);
   ...
   $('#button-shipping-address').live('click', function() {
      $.ajax({
         ...
         beforeSend: function() {
            ...
            $('#button-shipping-address').after('<span class="wait">&nbsp;<img src="http://casajosefa.com/catalog/view/theme/default/image/loading.gif" alt="" /></span>');
         },
         complete: function() {
   ...
   $('#button-guest').live('click', function() {
      $.ajax({
         ...
         beforeSend: function() {
            ...
            $('#button-guest').after('<span class="wait">&nbsp;<img src="http://casajosefa.com/catalog/view/theme/default/image/loading.gif" alt="" /></span>');
         },
         complete: function() {
   ...
   $('#button-guest-shipping').live('click', function() {
      $.ajax({
         ...
         beforeSend: function() {
            ...
            $('#button-guest-shipping').after('<span class="wait">&nbsp;<img src="http://casajosefa.com/catalog/view/theme/default/image/loading.gif" alt="" /></span>');
         },
         complete: function() {
   ...
   $('#button-shipping-method').live('click', function() {
      $.ajax({
         ...
         beforeSend: function() {
            ...
            $('#button-shipping-method').after('<span class="wait">&nbsp;<img src="http://casajosefa.com/catalog/view/theme/default/image/loading.gif" alt="" /></span>');
         },
         complete: function() {
   ...
   $('#button-payment-method').live('click', function() {
      $.ajax({
         url: 'modules/mod_ecomm/ecomm_eval_login.jsp?mod=json8&route=payment_method/validate',
         type: 'post',
         data: $('#payment-method input[type=\'radio\']:checked, #payment-method input[type=\'checkbox\']:checked, #payment-method textarea'),
         dataType: 'json',
         beforeSend: function() {
            $('#button-payment-method').attr('disabled', true);
            $('#button-payment-method').after('<span class="wait">&nbsp;<img src="http://casajosefa.com/catalog/view/theme/default/image/loading.gif" alt="" /></span>');
         },
         complete: function() {
         ...
         success: function(json) {
            ...
            if (json['redirect']) {
               ...
               $.ajax({
                  url: 'modules/mod_ecomm/ecomm_eval_login.jsp?mod=json9&route=checkout/confirm',
                  dataType: 'html',
                  success: function(html) {
