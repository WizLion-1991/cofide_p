...
<%
    ...
    if (varSesiones.getIntNoUser() != 0) {
        ...
        if (captcha.isCorrect(strAnswer)) {
            ...
            objTabla.setFieldInt("MSE_ID", periodo.getPeriodoSemanalActual(oConn));
            ...
            if (strResEntrega.equals("OK")) {
                ...
                intDigito = DigitoVerificador.CalculaModulo10(strKey, false);

                String strUpdate = "update vta_cliente set CT_RBANCARIA1 = '" + strKey + intDigito + "',CT_BANCO1 = 5 where CT_ID = " + strKey;
                 ...
                 */
                  String strPedido = GeneraPedido(oConn, varSesiones, intSC_ID,
                  intNvoKey, intMON_ID, intTI_ID, fecha, dblPrecio, dblTasa1,
                  dblTasa2, dblTasa3, intSImp1_2, intSImp1_3, intSImp2_3,
                  dblPuntos, dblNegocio, intCT_DIASCREDITO, strRegimenFiscal,
                  intPr_Id, strDescripcion, strCodigo, intExento1, intExento2,
                  intExento3, strUnidadMedida, strfolio_GLOBAL);
                 /*
