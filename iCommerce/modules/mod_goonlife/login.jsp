...
<%         } else {
   ...
   String strPeriodoSem = periodo.getPeriodoSemanalActualNom(oConn);

   //Obtenemos datos del cliente
   String strNomCicloActual = "";
   double dblPuntosGenerados = 0;
   double dblPuntosDisponibles = 0;
   String strEstatus = "INACTIVO";
   String strRango = "";
   int intNumHijos = 0;
   int intNumHijosActivos = 0;
   String strSql = "select * from vta_cliente where CT_ID = " + varSesiones.getintIdCliente();
   ResultSet rs = oConn.runQuery(strSql, false);
   while (rs.next()) {
      if (rs.getInt("CT_ACTIVO") == 1) {
         strEstatus = "ACTIVO";
      }
      if (rs.getInt("CT_NIVELRED") == 1) {
         strRango = "Distribuidor";
      }
      if (rs.getInt("CT_NIVELRED") == 2) {
         strRango = "Asociado";
      }
      if (rs.getInt("CT_NIVELRED") == 3) {
         strRango = "Emprendedor";
      }
      if (rs.getInt("CT_NIVELRED") == 4) {
         strRango = "Ejecutivo";
      }
      if (rs.getInt("CT_NIVELRED") == 5) {
         strRango = "Director";
      }
      if (rs.getInt("CT_NIVELRED") == 6) {
         strRango = "Empresario";
      }
      if (rs.getInt("CT_NIVELRED") == 7) {
         strRango = "Embajador ";
      }
      if (rs.getInt("CT_NIVELRED") == 8) {
         strRango = "Presidente";
      }
      if (rs.getInt("CT_NIVELRED") == 9) {
         strRango = "Chairman";
      }
      intNumHijos = rs.getInt("CT_CONTEO_HIJOS");
      intNumHijosActivos = rs.getInt("CT_CONTEO_HIJOS_ACTIVOS");
   }
   rs.close();
...
<div class="well ">
   ...
   <div id="accordion">
      ...
      <div>
         <div class="login-greeting">
            <table class="mlm_down1" cellpadding="3" cellspacin="0">
               ...
               <tr><td nowrap>&nbsp;Estatus:</td><td>&nbsp;<strong><%=strEstatus%></strong></td></tr>
               <tr><td nowrap>&nbsp;Rango:</td><td>&nbsp;<strong><%=strRango%></strong></td></tr>
               <tr><td nowrap>&nbsp;Ciclo Actual:</td><td>&nbsp;<strong><%=strNomCicloActual%></strong></td></tr>
               <tr><td nowrap>&nbsp;</td><td>&nbsp;<strong></strong></td></tr>
               <tr><td nowrap>&nbsp;Personas en mi red:</td><td>&nbsp;<strong><%=intNumHijos%></strong></td></tr>
               <tr><td nowrap>&nbsp;Personas activas:</td><td>&nbsp;<strong><%=intNumHijosActivos%></strong></td></tr>
               <tr><td nowrap>&nbsp;</td><td>&nbsp;<strong></strong></td></tr>
               <tr><td nowrap>&nbsp;Comisiones de la semana:</td><td>&nbsp;<strong><%="En construccion"%></strong></td></tr>
               <tr><td nowrap>&nbsp;Comisiones de el Mes:</td><td>&nbsp;<strong><%="En construccion"%></strong></td></tr>
               <tr><td nowrap>&nbsp;</td><td>&nbsp;<strong></strong></td></tr>
               <tr><td nowrap>&nbsp;Periodo:</td><td>&nbsp;<strong><%=strPeriodo%></strong></td></tr>
               <tr><td nowrap>&nbsp;Semana Actual:</td><td>&nbsp;<strong><%=strPeriodoSem%></strong></td></tr>
      ...
      <div>
         <ul>            
            <li><a href="index.jsp?mod=FZWebEditIngresos" class="aMenu"><img src="modules/mod_goonlife/images/Datos.png" border="0" width="20" height="20" alt="Mis datos" title="Mis datos" />Mis datos</a></li>
            <li><a href="index.jsp?mod=FZWebCambioContrasena" class="aMenu"><img src="modules/mod_goonlife/images/Contrasena2.png" border="0" width="20" height="20" alt="Cambio password" title="Cambio password" />Cambio contraseña</a></li>
         </ul>
      </div>
      ...
      <div>
         <ul>
            ...
            <li><a href="index.jsp?mod=FZWebIngresos" class="aMenu"><img src="modules/mod_goonlife/images/afiliacion.png" border="0" width="20" height="20" alt="Ingresos" title="Ingresos" />Nueva Afiliaciòn</a></li>
                  <%}%>
            <li><a href="index.jsp?mod=FZWebRed" class="aMenu"><img src="modules/mod_goonlife/images/red.png" border="0" width="20" height="20" alt="Mi Red" title="Mi Red" />Mi Red</a></li>
         </ul>
      </div>
      <h3>Mis reportes</h3>
      <div>
         <ul>
            <li><a href="index.jsp?mod=FZWebCompensacion" class="aMenu"><img src="modules/mod_goonlife/images/dinero.png" border="0" width="20" height="20" alt="Compensacion" title="Compensacion" />Estado de Cuenta</a></li>
            <li><a href="index.jsp?mod=FZWebVentas" class="aMenu"><img src="modules/mod_goonlife/images/ventas.png" border="0" width="20" height="20" alt="Ventas" title="Ventas" />Ventas</a></li>
         </ul>
      </div>
      <h3>Mis notificaciones</h3>
      <div>
         <ul>
            <li><a href="index.jsp?mod=FZWebSugerencias" class="aMenu"><img src="modules/mod_goonlife/images/sugerencias.png" border="0" width="20" height="20" alt="Sugerencias" title="Sugerencias" />Sugerencias</a></li>
         </ul>
      </div>
   </div>
         ...
         <div id="form-login-username" class="control-group">
            <div class="controls">
               <div class="input-prepend input-append">
                  ...
                  <input id="modlgn-username" type="text" name="username" class="input-small" tabindex="0" size="18" placeholder="ID"/>
               </div>
            </div>
         </div>
         <div id="form-login-password" class="control-group">
