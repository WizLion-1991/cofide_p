   ...
   <form action="index.jsp?mod=red_tabla" method="post"   id="tree-form" class="form-inline">
      <div class="userdata">
         ...
         <div id="form-new-submit" class="control-group">
            ...
            <div style="text-align: center;"><h2>Gr&aacute;fico</h2></div>
         </div>
         ...
         <div id="form-new-submit" class="control-group">
            ...
            <div style="text-align: center;"><h2>Gr&aacute;fico Binario Training</h2></div>
         </div>-->
         ...
         <div id="form-new-submit" class="control-group">
            ...
            <div style="text-align: center;"><h2>Gr&aacute;fico Binario Afiliado</h2></div>
         </div>-->
         ...
         <div id="form-new-submit" class="control-group">
            ...
            <div style="text-align: center;"><h2>Gr&aacute;fico Binario Global</h2></div>
         </div>-->
