...
<%
   ...
   if (varSesiones.getIntNoUser() != 0) {
      ...
      String stractivacion = request.getParameter("modlgn-activacion");
      ...
      if (captcha.isCorrect(strAnswer)) {
         ...
         objTabla.setFieldInt("CT_UPLINE", 7);
         ...
         objTabla.setFieldString("AUTO_ACTIVACION", stractivacion);
         ...
         if (strResult.equals("OK")) {
            ...
            String strInsert = "INSERT INTO mlm_listado (PROS_FOLIO, CT_ID, LIS_FECHA, LIS_HORA, CT_RAZONSOCIAL,AUTO_ACTIVACION) values ('" + strFolio + "','" + idCt + "','" + fechas.getFechaActual() + "','" + fechas.getHoraActual() + "','" + strRazonSocial + "','" + stractivacion + "')"; 
