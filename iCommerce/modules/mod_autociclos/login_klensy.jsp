   ...
   <div id="accordion">
      ...
      <div>
         <ul>
            ...
            <li><a href="index.jsp?mod=FZWebIngresos" class="aMenu"><img src="modules/mod_klensy/images/Nuevo ingreso.jpg" border="0" width="40" height="40" alt="Ingresos" title="Ingresos" />&nbsp;Ingresos</a></li>
                  <%}%>
            <li><a href="index.jsp?mod=red_grafica&Modo=Unilevel" class="aMenu"><img src="modules/mod_klensy/images/Referenciados.jpg" border="0" width="40" height="40" alt="Mis referenciados" title="Mis referenciados" />&nbsp;Referenciados</a></li>
            <li><a href="index.jsp?mod=FZWebRed" class="aMenu"><img src="modules/mod_klensy/images/Mi red.jpg" border="0" width="40" height="40" alt="Mi Red" title="Mi Red" />&nbsp;Mi Red</a></li>
            <li><a href="index.jsp?mod=FZWebNvoCentro" class="aMenu"><img src="modules/mod_klensy/images/Cuenta nueva.jpg" border="0" width="40" height="40" alt="Nuevo centro de negocios" title="Nuevo centro de negocios" />&nbsp;Agregar cuenta</a></li>
         </ul>
      </div>
      <h3>Mis reportes</h3>
      <div>
