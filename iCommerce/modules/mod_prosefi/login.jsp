...
<div class="well ">
   ...
   <div id="accordion">
      ...
      <div>
         <div class="login-greeting">
           ...
           <tr><td nowrap>&nbsp;Ciclo Actual:</td><td>&nbsp;<strong><%=strNomCicloActual%></strong></td></tr>
               ...
               <tr><td nowrap>&nbsp;Fecha actual:</td><td>&nbsp;<strongecha.getFechaActualDDMMAAAADiagonal()%></strong></td></tr>
            </table>
         </div>
      </div>
      ...
      <div>
         <ul>
            <li><a href="index.jsp?mod=FZWebsolicitud" class="aMenu"><img src="images/solicitud.png" border="0" width="40" height="40" alt="Solicitud" title="Solicitud" />Solicitud</a></li>
            <li><a href="index.jsp?mod=subir_doc" class="aMenu"><img src="images/documento.png" border="0" width="40" height="40" alt="Documento" title="Documento" />Subir Documento</a></li>
            <li><a href="index.jsp?mod=FZWebcredito" class="aMenu"><img src="images/credito.png" border="0" width="40" height="40" alt="Credito" title="Credito" />Mi Credito</a></li>
             <li><a href="index.jsp?mod=FZWebSugerencias" class="aMenu"><img src="images/estadocuenta.png" border="0" width="40" height="40" alt="Cuenta" title="Cuenta" />Estado de Cuenta</a></li>
         </ul>
      </div>
