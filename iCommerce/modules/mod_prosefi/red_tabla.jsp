   ...
   $(document).ready(function() {
      $("#list").jqGrid({
         ...
         colModel: [
            ...
            {name: 'ct_telefono1', hidden: 'ct_telefono1', width: 40, sortable: false, align: "right", search:false},
            {name: 'ct_telefono2', hidden: 'ct_telefono2', width: 40, sortable: false, align: "right", search:false},
            {name: 'ct_email1', hidden: 'ct_email1', width: 40, sortable: false, align: "right", search:false},
