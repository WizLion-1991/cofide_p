...
<script type="text/javascript" src="modules/mod_multimatrix/js/ecomm.js"></script>
<!--slide 3d -->
...
<!--light box -->
<!--ecommerce -->
<link rel="stylesheet" type="text/css" href="modules/mod_multimatrix/css/ecomm.css" />
...
<!--Mensajes de promociones-->
<!--Busqueda-->
<jsp:include page="../../modules/mod_multimatrix/ecomm_search.jsp" />
<!--Busqueda-->
