...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<%= webBase.getStrLanguage()%>" lang="<%= webBase.getStrLanguage()%>" dir="<%= webBase.getStrDirection()%>" >
   ...
   <body class="site com_content view-article no-layout no-task itemid-435">
      <div class="well ">
         ...
         <form action="modules/mod_klensy/ingresos_save_ext.jsp" method="post" onsubmit="return  EvaluaFormulario();" id="login-form" class="form-inline">
            <div class="userdata">
                  ...
                  <div class="controls">
                     ...
                     <table cellpadding="4" cellspacing="1" border="0" style="background-color: #739dd3;">
                        <tr>
                           ...
                           <td>&nbsp;<input id="modlgn-sponsor" type="text" name="sponsor" class="input-medium-ingresos" tabindex="0" size="30" maxlength="29" placeholder="Id de quien Invito"/></td>
                        </tr>
                        <tr>
