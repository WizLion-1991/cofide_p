            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    ...
                    <div id="content" class="span9">
                        ...
                        %><jsp:include page="../../modules/mod_v15matriz/ingresos.jsp" />
                        <%}

                            //Centro de negocios
                            if (strModulo.equals("FZWebNvoCentro")) {
                        %><jsp:include page="../../modules/mod_v15matriz/centro_negocios.jsp" />
                        <%}
                            //Centro de negocios SAVE
                            if (strModulo.equals("FZWebNvoCentroSave")) {
                        %><jsp:include page="../../modules/mod_v15matriz/centro_negocios_save.jsp" />
                        <%}
                            //Red
                            if (strModulo.equals("FZWebRed")) {
                        %><jsp:include page="../../modules/mod_v15matriz/red.jsp" />
                        <%                     }
                        ...
                        %><jsp:include page="../../modules/mod_v15matriz/red_grafica.jsp" />
                        <%                     }
                        ...
                        %><jsp:include page="../../modules/mod_v15matriz/sugerencias.jsp" />
                        <%}
                            //Sugerencias
                            if (strModulo.equals("ingresos_save")) {
                        %><jsp:include page="../../modules/mod_v15matriz/ingresos_save.jsp" />
                        <%}
                            //Sugerencias_save
                            if (strModulo.equals("sugerencias_save")) {
                        %><jsp:include page="../../modules/mod_v15matriz/sugerencias_save.jsp" />
                        <%                     }
                            //ecommerce
...
%>
                    ...
                    <div id="aside" class="span3">
                        ...
                        <!-- End Right Sidebar -->
                        <!--Ecomm -->
                        <jsp:include page="../../modules/mod_v15matriz/ecomm_right.jsp" />
                        <!--Ecomm -->
                        <!--Formato de login-->
                        <jsp:include page="../../modules/mod_v15matriz/login.jsp" />
                        <!--Formato de login-->
