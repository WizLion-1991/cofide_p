...
<%
   ...
   TemplateParams templateparams = new TemplateParams(oConn, "Klensy", webBase.getStrLanguage());
   // get params
         ...
         <div class="container">
            ...
            <div class="row-fluid">
               ...
               <div id="content" class="span9">
                  ...
                  %><jsp:include page="../../modules/mod_autociclos/home.jsp" />
                  <%}
                     //Login
                     if (strModulo.equals("FZWebLogin2")) {
                  %><jsp:include page="../../modules/mod_autociclos/login_eval.jsp" />
                  <%}
                     //Logo out
                  ...
                  %><jsp:include page="../../modules/mod_autociclos/ingresos.jsp" />
                  <%}
                     //Red
                     if (strModulo.equals("FZWebRed")) {
                  %><jsp:include page="../../modules/mod_autociclos/red.jsp" />
                  <%                     }
                  ...
                  %><jsp:include page="../../modules/mod_autociclos/red_grafica.jsp" />
                  <%                     }
                  ...
                  %><jsp:include page="../../modules/mod_autociclos/ingresos_save.jsp" />
                  <%}
                     //Sugerencias_save
                  ...
                  %><jsp:include page="../../modules/mod_autociclos/ecomm.jsp" />
                  <%                     }
                  ...
                  %><jsp:include page="../../modules/mod_autociclos/centro_negocios.jsp" />
                  <%}
                     //Guardar nuevo centro de negocios
                     if (strModulo.equals("FZWebNvoCentroSave")) {
                  %><jsp:include page="../../modules/mod_autociclos/centro_negocios_save.jsp" />
                  <%}
                     //Cambiar comision por dinero
                     if (strModulo.equals("FZWebKLCambio")) {
                  %><jsp:include page="../../modules/mod_autociclos/cambio_comision.jsp" />
                  <%}
                     //Guardar cambio de comision por dinero
                     if (strModulo.equals("FZWebKLCambioSave")) {
                  %><jsp:include page="../../modules/mod_autociclos/cambio_comision_save.jsp" />
                  <%}
                     //Guardar cambio de comision por dinero
                     if (strModulo.equals("FZWebHistorial")) {
                  %><jsp:include page="../../modules/mod_autociclos/historial_movimientos.jsp" />
                  <%}
...
%>
               ...
               <div id="aside" class="span3">
                  ...
                  <!--Ecomm -->
                  <!--Formato de login-->
                  <jsp:include page="../../modules/mod_autociclos/login_klensy.jsp" />
                  <!--Formato de login-->
                  <!--Link para las redes sociales-->
                  <jsp:include page="../../modules/mod_autociclos/social.jsp" />
                  <!--Link para las redes sociales-->
                  <!--Ecomm -->
