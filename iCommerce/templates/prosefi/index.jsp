...
<%
   ...
   TemplateParams templateparams = new TemplateParams(oConn, "prosefi", webBase.getStrLanguage());
   // get params
               ...
               <div id="content" class="span9">
                  ...
                  <%
                     //******************* MODULOS DE FUERZA DE VENTAS ****************
                      ...
                      //Credito
                     if (strModulo.equals("FZWebcredito")) {
                  %><jsp:include page="../../modules/mod_prosefi/credito.jsp" />
                  <%}
                     //Inicio
                  ...
                  %><jsp:include page="../../modules/mod_prosefi/red_tabla.jsp" />
                  <%                     }
                  ...
                  <%}
                     //Solicitud
                     if (strModulo.equals("FZWebsolicitud")) {
                  %><jsp:include page="../../modules/mod_prosefi/solicitud.jsp" />
                  <%}
                     //Subir documentacion
                     if (strModulo.equals("subir_doc")) {
                  %><jsp:include page="../../modules/mod_prosefi/subir_archivo.jsp" />
                  <%}
                     //Sugerencias
                  ...
                  <%                     }
                     //Top Sponsor
                     if (strModulo.equals("top_sponsor")) {
                  %><jsp:include page="../../modules/mod_prosefi/top_sponsor.jsp" />
                  <%                     }
                     //guarda modificacion
...
%>
               ...
               <div id="aside" class="span3">
                  ...
                  <!-- End Right Sidebar -->
                  <!--Ecomm -->
                  <jsp:include page="../../modules/mod_prosefi/ecomm_right.jsp" />
                  <!--Ecomm -->
                  <!--Formato de login-->
                  <jsp:include page="../../modules/mod_prosefi/login.jsp" />
                  <!--Formato de login-->
