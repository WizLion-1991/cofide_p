...
<%
   ...
   TemplateParams templateparams = new TemplateParams(oConn, "goonlife", webBase.getStrLanguage());
   // get params
         ...
         <div class="container">
            ...
            <div class="row-fluid">
               ...
               <div id="content" class="span9">
                  ...
                  %><jsp:include page="../../modules/mod_goonlife/home.jsp" />
                  <%}
                     //Login
                  ...
                  %><jsp:include page="../../modules/mod_goonlife/ingresos.jsp" />
                  <%}
                     //Red
                  ...
                  %><jsp:include page="../../modules/mod_goonlife/ingresos_save.jsp" />
                  <%}
                     //Sugerencias_save
...
%>
               ...
               <div id="aside" class="span3">
                  ...
                  <!-- End Right Sidebar -->
                  <!--Ecomm -->
                  <jsp:include page="../../modules/mod_goonlife/ecomm_right.jsp" />
                  <!--Ecomm -->
                  <!--Formato de login-->
                  <jsp:include page="../../modules/mod_goonlife/login.jsp" />
                  <!--Formato de login-->
                  <!--Link para las redes sociales-->
                  <jsp:include page="../../modules/mod_goonlife/social.jsp" />
                  <!--Link para las redes sociales-->
                  <!--Ecomm -->
