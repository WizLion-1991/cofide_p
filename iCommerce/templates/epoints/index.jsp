...
<%
    ...
    TemplateParams templateparams = new TemplateParams(oConn, "epoints", webBase.getStrLanguage());
    // get params
            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    ...
                    <div id="content" class="span9">
                        ...
                        %><jsp:include page="../../modules/mod_epoints/home.jsp" />
                        <%}
                            //Login
                            if (strModulo.equals("FZWebLogin2")) {
                        %><jsp:include page="../../modules/mod_epoints/login_eval.jsp" />
                        <%}
                            //Logo out
                        ...
                        %><jsp:include page="../../modules/mod_epoints/ingresos.jsp" />
                        <%}
                            //Red
                            if (strModulo.equals("FZWebRed")) {
                        %><jsp:include page="../../modules/mod_epoints/red.jsp" />
                        <%                     }
                            //Vista de red en tabla
                            if (strModulo.equals("red_tabla")) {
                        %><jsp:include page="../../modules/mod_epoints/red_tabla.jsp" />
                        <%                     }
                            //Vista de red en grafica
                            if (strModulo.equals("red_grafica")) {
                        %><jsp:include page="../../modules/mod_epoints/red_grafica.jsp" />
                        <%                     }
                        ...
                        %><jsp:include page="../../modules/mod_epoints/ingresos_save.jsp" />
                        <%}
                            //Sugerencias_save
                        ...
                        %><jsp:include page="../../modules/mod_epoints/ecomm.jsp" />
                        <%                     }
                        ...
                        <%}
                            ...
                            if (strModulo.equals("FZWebNvoCentro")) {
                        %><jsp:include page="../../modules/mod_epoints/centro_negocios.jsp" />
                        <%}
                            //Guardar nuevo centro de negocios
                            if (strModulo.equals("FZWebNvoCentroSave")) {
                        %><jsp:include page="../../modules/mod_epoints/centro_negocios_save.jsp" />
                        <%}
                            //Cambiar comision por dinero
                            if (strModulo.equals("FZWebKLCambio")) {
                        %><jsp:include page="../../modules/mod_epoints/cambio_comision.jsp" />
                        <%}
                            //Guardar cambio de comision por dinero
                            if (strModulo.equals("FZWebKLCambioSave")) {
                        %><jsp:include page="../../modules/mod_epoints/cambio_comision_save.jsp" />
                        <%}
                            //Guardar cambio de comision por dinero
                            if (strModulo.equals("FZWebHistorial")) {
                        %><jsp:include page="../../modules/mod_epoints/historial_movimientos.jsp" />
                        <%}
                            //Guardar cambio de comision por dinero
                            if (strModulo.equals("FZGeneraPass")) {
                        %><jsp:include page="../../modules/mod_fz/genera_pass.jsp?Opt=getScLose" />
                        <%}
                    ...
                    <div id="aside" class="span3">
                        ...
                        <!-- End Right Sidebar -->
                        <!--Ecomm -->
                        <jsp:include page="../../modules/mod_epoints/ecomm_right.jsp" />
                        <!--Ecomm -->
                        <!--Formato de login-->
                        <jsp:include page="../../modules/mod_epoints/login_klensy.jsp" />
                        <!--Formato de login-->
                        <!--Link para las redes sociales-->
                        <jsp:include page="../../modules/mod_epoints/social.jsp" />
                        <!--Link para las redes sociales-->
                        <!--Ecomm -->
