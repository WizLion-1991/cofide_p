...
<%
   ...
   TemplateParams templateparams = new TemplateParams(oConn, "Multimatrix", webBase.getStrLanguage());
   // get params
         ...
         <div class="container">
            ...
            <div class="row-fluid">
               ...
               <div id="content" class="span9">
                  ...
                  %><jsp:include page="../../modules/mod_multimatrix/home.jsp" />
                  <%}
                     //Login
                     if (strModulo.equals("FZWebLogin2")) {
                  %><jsp:include page="../../modules/mod_multimatrix/login_eval.jsp" />
                  <%}
                     //Logo out
                  ...
                  %><jsp:include page="../../modules/mod_multimatrix/ingresos.jsp" />
                  <%}
                     //Red
                     if (strModulo.equals("FZWebRed")) {
                  %><jsp:include page="../../modules/mod_multimatrix/red.jsp" />
                  <%                     }
                  ...
                  %><jsp:include page="../../modules/mod_multimatrix/red_grafica.jsp" />
                  <%                     }
                  ...
                  %><jsp:include page="../../modules/mod_multimatrix/ingresos_save.jsp" />
                  <%}
                     //Sugerencias_save
                  ...
                  %><jsp:include page="../../modules/mod_multimatrix/ecomm.jsp" />
                  <%                     }
                  ...
                  %><jsp:include page="../../modules/mod_multimatrix/centro_negocios.jsp" />
                  <%}
                     //Guardar nuevo centro de negocios
                     if (strModulo.equals("FZWebNvoCentroSave")) {
                  %><jsp:include page="../../modules/mod_multimatrix/centro_negocios_save.jsp" />
                  <%}
                     //Cambiar comision por dinero
                     if (strModulo.equals("FZWebKLCambio")) {
                  %><jsp:include page="../../modules/mod_multimatrix/cambio_comision.jsp" />
                  <%}
                     //Guardar cambio de comision por dinero
                     if (strModulo.equals("FZWebKLCambioSave")) {
                  %><jsp:include page="../../modules/mod_multimatrix/cambio_comision_save.jsp" />
                  <%}
                     //Guardar cambio de comision por dinero
                     if (strModulo.equals("FZWebHistorial")) {
                  %><jsp:include page="../../modules/mod_multimatrix/historial_movimientos.jsp" />
                  <%}
...
%>
               ...
               <div id="aside" class="span3">
                  ...
                  <!--Ecomm -->
                  <!--Formato de login-->
                  <jsp:include page="../../modules/mod_multimatrix/login_klensy.jsp" />
                  <!--Formato de login-->
                  <!--Link para las redes sociales-->
                  <jsp:include page="../../modules/mod_multimatrix/social.jsp" />
                  <!--Link para las redes sociales-->
                  <!--Ecomm -->
