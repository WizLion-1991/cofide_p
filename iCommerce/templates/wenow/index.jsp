...
<%
   ...
   TemplateParams templateparams = new TemplateParams(oConn, "wenow", webBase.getStrLanguage());
   // get params
         ...
         <div class="container">
            ...
            <div class="row-fluid">
               ...
               <div id="content" class="span9">
                  ...
                  %><jsp:include page="../../modules/mod_wenow/ingresos.jsp" />
                  <%}
                     //Red
                     if (strModulo.equals("FZWebRed")) {
                  %><jsp:include page="../../modules/mod_wenow/red.jsp" />
                  <%                     }
                  ...
                  %><jsp:include page="../../modules/mod_wenow/red_grafica.jsp" />
                  <%                     }
                  ...
                  %><jsp:include page="../../modules/mod_wenow/ingresos_save.jsp" />
                  <%}
                     //Sugerencias_save
                  ...
                  %><jsp:include page="../../modules/mod_wenow/ingresos_edit.jsp" />
                  <%                     }
                     //guarda modificacion
                     if (strModulo.equals("FZWebEditIngresosSave")) {
                  %><jsp:include page="../../modules/mod_wenow/ingresos_edit_save.jsp" />
                  <%                     }
                  ...
                  <%}
                     //Añadir Plan
                     if (strModulo.equals("FZAnaPlan")) {
                  %><jsp:include page="../../modules/mod_fz/modiplan.jsp" />
                  <%                     }
                     //******************* MODULOS DE FUERZA DE VENTAS ****************
                  %>
                  <!-- End Content -->
               ...
               <div id="aside" class="span3">
                  ...
                  <!--Ecomm -->
                  <!--Formato de login-->
                  <jsp:include page="../../modules/mod_wenow/login.jsp" />
                  <!--Formato de login-->
