         ...
         <div class="container">
            ...
            <div class="row-fluid">
               ...
               <div id="content" class="span9">
                  ...
                  %><jsp:include page="../../modules/mod_prosperidad/ingresos.jsp" />
                  <%}
                     //Red
                  ...
                  %><jsp:include page="../../modules/mod_prosperidad/centro_negocios.jsp" />
                  <%}
                  //Centro de negocios SAVE
                  if (strModulo.equals("FZWebNvoCentroSave")) {
                  %><jsp:include page="../../modules/mod_prosperidad/centro_negocios_save.jsp" />
                  <%}
                  
                  
                     //Vista de red en tabla
                     if (strModulo.equals("red_tabla")) {
                  %><jsp:include page="../../modules/mod_prosperidad/red_tabla.jsp" />
                  <%                     }
                  ...
                  %><jsp:include page="../../modules/mod_prosperidad/ingresos_save.jsp" />
                  <%}
                     //Sugerencias_save
...
%>
               ...
               <div id="aside" class="span3">
                  ...
                  <!--Ecomm -->
                  <!--Formato de login-->
                  <jsp:include page="../../modules/mod_prosperidad/login.jsp" />
                  <!--Formato de login-->
