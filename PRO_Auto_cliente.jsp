<%-- 
    Document   : pro_auto_cliente
    Created on : 11/04/2013, 10:12:49 AM
    Author     : SIWEB
--%>
      ...
      if (varSesiones.getIntNoUser() != 0 && seg.ValidaURL(request)) {
         ...
         if(!strValorBuscar.trim().equals("")){
            ...
            String strSql = "SELECT CT_ID,CT_RAZONSOCIAL,CT_RFC " +
                    ...
                    "CT_RAZONSOCIAL LIKE '" + strValorBuscar + "%'  ORDER BY CT_RAZONSOCIAL";
            ResultSet rsCombo;
            try {
               rsCombo = oConn.runQuery(strSql, true);
               while (rsCombo.next()) {
                  String strNumero = rsCombo.getString("CT_ID");
                  String strNombre = rsCombo.getString("CT_RAZONSOCIAL") + "(" + rsCombo.getString("CT_RFC") +")";
