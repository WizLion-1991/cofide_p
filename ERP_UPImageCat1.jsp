...
<%
    ...
    if (varSesiones.getIntNoUser() != 0 && seg.ValidaURL(request)) {
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            ...
            String intPC_ID = request.getParameter("PC_ID");
            ...
            while (it.hasNext()) {
                ...
                if (fileItem.isFormField()) {
                    ...
                    if (fileName.toLowerCase().endsWith(".png") || fileName.toLowerCase().endsWith(".jpg")) {
                        ...
                        String strUpdate = "";
                        if (fieldName.equals("PC_IMSGEN1")) {
                            strUpdate = "UPDATE vta_prodcat1 set ";
                            strUpdate += " PC_NOMIMG1= '" + strPathUsado + "' ,";
                            strUpdate += " PC_IMG1= '" + 1 + "'";
                            strUpdate += " WHERE PC_ID = " + intPC_ID;
                        }
                        if (fieldName.equals("PC_IMSGEN2")) {
                            strUpdate = "UPDATE vta_prodcat1 set ";
                            strUpdate += " PC_NOMIMG2= '" + strPathUsado + "' ,";
                            strUpdate += " PC_IMG2= '" + 1 + "'";
                            strUpdate += " WHERE PC_ID = " + intPC_ID;
                        } 
                        if (fieldName.equals("PC_IMSGEN3")) {
                            strUpdate = "UPDATE vta_prodcat1 set ";
                            strUpdate += " PC_NOMIMG3= '" + strPathUsado + "' ,";
                            strUpdate += " PC_IMG3= '" + 1 + "'";
                            strUpdate += " WHERE PC_ID = " + intPC_ID;
                        } 
                        if (fieldName.equals("PC_IMSGEN4")) {
                            strUpdate = "UPDATE vta_prodcat1 set ";
                            strUpdate += " PC_NOMIMG4= '" + strPathUsado + "' ,";
                            strUpdate += " PC_IMG4= '" + 1 + "'";
                            strUpdate += " WHERE PC_ID = " + intPC_ID;
                        } 
                        if (fieldName.equals("PC_IMSGEN5")) {
                            strUpdate = "UPDATE vta_prodcat1 set ";
                            strUpdate += " PC_NOMIMG5= '" + strPathUsado + "' ,";
                            strUpdate += " PC_IMG5= '" + 1 + "'";
                            strUpdate += " WHERE PC_ID = " + intPC_ID;
                        } 
