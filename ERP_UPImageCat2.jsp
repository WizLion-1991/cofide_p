...
<%
    ...
    if (varSesiones.getIntNoUser() != 0 && seg.ValidaURL(request)) {
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            ...
            String intPC2_ID = request.getParameter("PC2_ID");
            ...
            while (it.hasNext()) {
                ...
                if (fileItem.isFormField()) {
                    ...
                    if (fileName.toLowerCase().endsWith(".png") || fileName.toLowerCase().endsWith(".jpg")) {
                        ...
                        String strUpdate = "";
                        if (fieldName.equals("PC2_IMSGEN1")) {
                            strUpdate = "UPDATE vta_prodcat2 set ";
                            strUpdate += " PC2_NOMIMG1= '" + strPathUsado + "' ,";
                            strUpdate += " PC2_IMG1= '" + 1 + "'";
                            strUpdate += " WHERE PC2_ID = " + intPC2_ID;
                        }
                        if (fieldName.equals("PC2_IMSGEN2")) {
                            strUpdate = "UPDATE vta_prodcat2 set ";
                            strUpdate += " PC2_NOMIMG2= '" + strPathUsado + "' ,";
                            strUpdate += " PC2_IMG2= '" + 1 + "'";
                            strUpdate += " WHERE PC2_ID = " + intPC2_ID;
                        } 
                        if (fieldName.equals("PC2_IMSGEN3")) {
                            strUpdate = "UPDATE vta_prodcat2 set ";
                            strUpdate += " PC2_NOMIMG3= '" + strPathUsado + "' ,";
                            strUpdate += " PC2_IMG3= '" + 1 + "'";
                            strUpdate += " WHERE PC2_ID = " + intPC2_ID;
                        } 
                        if (fieldName.equals("PC2_IMSGEN4")) {
                            strUpdate = "UPDATE vta_prodcat2 set ";
                            strUpdate += " PC2_NOMIMG4= '" + strPathUsado + "' ,";
                            strUpdate += " PC2_IMG4= '" + 1 + "'";
                            strUpdate += " WHERE PC2_ID = " + intPC2_ID;
                        } 
                        if (fieldName.equals("PC2_IMSGEN5")) {
                            strUpdate = "UPDATE vta_prodcat2 set ";
                            strUpdate += " PC2_NOMIMG5= '" + strPathUsado + "' ,";
                            strUpdate += " PC2_IMG5= '" + 1 + "'";
                            strUpdate += " WHERE PC2_ID = " + intPC2_ID;
                        } 
