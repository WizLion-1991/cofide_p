<%-- 
    Document   : ERP_UPFileXML
    Created on : 11/07/2014, 12:33:10 PM
    Author     : siwebmx5
--%>
            ...
            while (it.hasNext()) {
                ...
                if (fileItem.isFormField()) {
                    ...
                    if (fileName.toLowerCase().endsWith(".xml")) {
                        ...
                        String strPathUsado = strPathBase + "document" + strSeparator + "CuentasXPagar" + strSeparator + fileName;
                        ...
                        if (!saveTo.exists()) {
                            ...
                            MovProveedor MovP = new MovProveedor(oConn,varSesiones);
                             MovP.CargaDatosXML(strPathUsado);
                             strUUID = MovP.getStrUUID();
                        }else
                        {
