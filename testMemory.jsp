...
<%
      ...
      if (varSesiones.getIntNoUser() == 0) {
         ...
         String strSql = "SELECT FAC_ID,EMP_ID,FAC_NOAPROB,FAC_FECHAAPROB FROM vta_facturas where FAC_ID in (1) ";
         ResultSet rs = oConn.runQuery(strSql);
         while (rs.next()) {
            int intFacId = rs.getInt("FAC_ID");
            int intEMP_ID = rs.getInt("EMP_ID");
            String strNoAprob = rs.getString("FAC_NOAPROB");
            String strFechaAprob = rs.getString("FAC_FECHAAPROB");
            ...
            //Regeneramos el CFD
            SATXml3_0 SAT = new SATXml3_0(intFacId, strPathXML,
            ...
            out.println("Inicio..." + fecha.getFechaActual() + " " + fecha.getHoraActualHHMMSS());
            String strRes = SAT.GeneraXml();
            out.println("Termino..." + fecha.getFechaActual() + " " + fecha.getHoraActualHHMMSS());
            out.println("Regeneramos la factura... " + intFacId + " " + strRes +  " <br>");
         }
         rs.close();
      } else {
      }
