...
<%
      ...
      if (1 == 1) {
         ...
         String strSql = "SELECT NC_ID,EMP_ID,NC_NOAPROB,NC_FECHAAPROB FROM vta_ncredito where NC_ID in (80) ";
         ...
         while (rs.next()) {
            ...
            out.println("strPassKey:" + strPassKey);
            //Regeneramos el CFD
            ...
            SAT.setStrPathConfigPAC(strPathPrivateKeys);
            SAT.setBolEsNc(true);
