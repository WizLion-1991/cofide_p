<%-- 
    Document   : ERP_VentasRepo
    Created on : 23/04/2014, 11:10:46 AM
    Author     : N4v1d4d3s
--%>

<%@page import="com.mx.siweb.erp.reportes.RepoVentas"%>
   ...
   if (varSesiones.getIntNoUser() != 0 && seg.ValidaURL(request)) {
      ...
      if (strid != null) {
         ...
         if (strid.equals("1")) {
            ...
            RepoVentas b = new RepoVentas(strFechaInicial,strFechaFinal,strCodigo,intFamilia ,intSeleccion ,intSucursal,intEmpresa, oConn);
