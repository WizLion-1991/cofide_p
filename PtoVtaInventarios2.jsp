<%-- 
    Document   : PtoVtaInventarios2
    Created on : 10-nov-2013, 14:20:16
    Author     : ZeusGalindo
--%>
...
<html>
   <head>
      ...
      <style type="text/css">
         ...
         .cmd_btn {
            ...
            background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #F5280D), color-stop(1, #FA523C) );
            background:-moz-linear-gradient( center top, #F5280D 5%, #FA523C 100% );
            filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#F5280D', endColorstr='#FA523C');
         ...
         .cmd_btn:hover {
            background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #FA523C), color-stop(1, #5EA7EB) );
            background:-moz-linear-gradient( center top, #FA523C 5%, #F5280D 100% );
            filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#FA523C', endColorstr='#5EA7EB');
   ...
   <center>
      <div>
         <div id="head_cmd">
            <div class="title1_cmd">PASTELERIA DEL ANGEL - SALIDAS-</div>
            <button id="cmd_btn1" name="cmd_btn1" onclick="NewInvP()" class="cmd_btn">Nuevo</button>
            <button id="cmd_btn2" name="cmd_btn2" onclick="SaveInvP(2)" class="cmd_btn">Guardar</button>
