            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    ...
                    <div id="content" class="span9">
                        ...
                        <%}
                            //Reporte Ventas
                            if (strModulo.equals("FZWebRepoVentas")) {
                        %><jsp:include page="../../modules/mod_fz/repo_ventas.jsp" />
                        <%}
                            //Reporte Ventas(2) listado
                            if (strModulo.equals("FZWebRepoVentasList")) {
                        %><jsp:include page="../../modules/mod_fz/repo_ventas_listado.jsp" />
                        <%}
                    ...
                    <div id="aside" class="span3">
                        ...
                        <!--Ecomm -->
                        <!--Formato de login-->
                        <jsp:include page="../../modules/mod_fz/login.jsp" />
                        <!--Formato de login-->
