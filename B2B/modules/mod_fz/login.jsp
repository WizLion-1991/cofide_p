...
<div class="well ">
    ...
    <div id="accordion">
        ...
        <div>
            <ul>
                <li><a href="#" class="aMenu"><img src="images/comisiones.png" border="0" width="40" height="40" alt="Confirmar" title="Confirmar Ventas" />Confirmar Ventas</a></li>
                <li><a href="index.jsp?mod=FZWebRepoVentas" class="aMenu"><img src="images/ventas.png" border="0" width="40" height="40" alt="Ventas" title="Ventas" />Ventas</a></li>
            </ul>
        </div>
    </div>
...
%>
<div class="well ">
    <h3 class="page-header">Acceso B2B</h3>
