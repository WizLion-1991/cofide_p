        ...
        <table class="table1">
            <%
                ...
                String strSQLNFecha = "select count(CC_FECHA_INICIAL) as NFechas , CC_FECHA_INICIAL"
                        + " from cofide_cursos where CC_FECHA_INICIAL >= '" + fec.getFechaActual() + "' GROUP BY CC_FECHA_INICIAL ORDER BY CC_FECHA_INICIAL";
            ...
            <tr class="tr1">
                ...
                <%
                    String strSQL = "select *,"
                            ...
                            + "from cofide_cursos as cc where CC_FECHA_INICIAL = '" + rsNFechas.getString("CC_FECHA_INICIAL") + "' order by CC_FECHA_INICIAL";
                ...
                %>
                <td class="td1">
                    <input style="button" value="Lista asistencia" onclick="OpnDetalleCurso(<%=rs.getString("CC_CURSO_ID")%>)" size="10px" class="btn btn-default btn-lg active" title="Listado de asistencia">
                </td>
                <%
                    }
                %>
