...
/**Carga por ajax los datos en json de la red*/
function init(intNodoRoot){
   var json = null;
   var urlData = "MLM_process.jsp?id=8&NodoId=" + intNodoRoot;
   $.getJSON( urlData, {
      format: "json"
   })
   .done(function( data ) {
...
//         Log.write("Abriendo nodos " + node.name);
//      },
//        
//      onAfterCompute: function(){
//         Log.write("Nodos cargados");
//      },
//        
...
//         label.id = node.id;            
//         label.innerHTML = node.id.replace("node","") + " " + node.name;
//         label.onclick = function(){
//            var datos_nodo = node.data; 
//            //alert("Estas viendo al nodo " + node.id + " " + datos_nodo );
//            //Cargamos los datos del nodo que se esta explorando ... 
//            _CargaDatosNodo(node.id)
//            //Peticion por ajax para ver su informacion
...
//               node.data.$color = ['#C4DFF0', '#7A9EC2', '#41688B', '#FC6822', '#F8EFDE', '#F1E3C6','#F8EFDE'][count];                    
//            }
//         }
//      },
//        
...
/**Muestra el detalle de datos del lado derecho*/
function _CargaDatosNodo(intNodo){
