<%-- 
    Document   : COFIDE_curso_tipo
    Created on : 06-mar-2016, 13:50:06
    Author     : juliocesar
--%>
...
//    if (varSesiones.getIntNoUser() != 0 && seg.ValidaURL(request)) {
    ...
    String strVendidos = "";
    String strTipo = request.getParameter("CACT_TIPO2");
    String FechaActual = fec.getFechaActual();
    String strSql = "select *, (CC_MONTAJE - CC_INSCRITOS) as DISPONIBLES from cofide_cursos where" + strTipo + " and CC_FECHA_INICIAL >= " + FechaActual;
...
<center>
    <table width="100%" cellspacing="0" cellpadding=30" border="5">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    <td>
                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                <td class="txt00 txt04 decora02"><%=strInstructor%></td>
                            </tr>
                            <tr>
                                <td class="detalle">
        ...
        <center>
            ...
            <div class="ligaGrafica" onclick="DrawGraphicTipo(<%=intCursoId%>,<%=strVendidos%>,<%=strDisponible%>)">Grafica</div>
            <div id="cofide_grafica_tipo<%=intCursoId%>" style="width: 200px; height: 300"></div>
        </center>
        </td>
    </table>
</center>
