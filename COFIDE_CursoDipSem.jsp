        ...
        <table class="table1">
            <%
                ...
                String strSQLNFecha = "select count(CC_FECHA_INICIAL) as NFechas , CC_FECHA_INICIAL, CC_IS_SEMINARIO, CC_IS_DIPLOMADO"
                        + " from cofide_cursos where CC_FECHA_INICIAL >= '" + fec.getFechaActual() + "' and (cc_is_seminario = 1 or cc_is_diplomado = 1) GROUP BY CC_FECHA_INICIAL,CC_IS_DIPLOMADO, CC_IS_SEMINARIO ORDER BY CC_FECHA_INICIAL";
            ...
            <tr class="tr1">
                ...
                <%
                    String strSQL = "select *,"
                            ...
                            + "from cofide_cursos cc where CC_FECHA_INICIAL = '" + strFechaIni + "' and CC_IS_SEMINARIO = " + intSeminario + " and CC_IS_DIPLOMADO = " + intDiplomado + " order by CC_FECHA_INICIAL";
